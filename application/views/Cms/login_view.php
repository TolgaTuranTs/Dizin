                ...
                <div class="m-t-10 p-20">
                    ...
                    <form class="m-t-20" action="" method="POST">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-12">
                                <input class="form-control" name="username" type="text" required="" placeholder="Yönetici Adınız">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-xs-12">
                        ...
                        <div class="form-group text-center row m-t-10">
                            <div class="col-xs-12">
                                <button class="btn btn-success btn-block waves-effect waves-light" name="girisF" type="submit">Sisteme Giriş Yap</button>
                            </div>
                        </div>
                    </form>
                </div>
